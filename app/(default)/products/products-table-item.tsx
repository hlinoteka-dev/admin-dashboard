	...
	return (
		<tr>
			<td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
				<div className="font-medium text-sky-500">{product.name}</div>
			</td>
			<td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
			...
			<td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
				<FormSwitches active={product.top} switchType="top" />
			</td>
			<td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
				<FormSwitches active={product.new} switchType="new" />				
			</td>
			...
			<td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
				<div className="space-x-1">
					...
					<ProductsTableItemDelete productName={product.name} />
				</div>
			</td>
		</tr>
	)
