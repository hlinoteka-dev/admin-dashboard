...
export async function POST(request: Request) {
	...
	const { name, price, author, size, topProduct, newProduct, productTags, images } = requestBody
...
export async function PUT(request: Request) {
	await mongooseConnect()
	const requestBody = await request.json()
	const { _id, name, price, author, size, topProduct, newProduct, productTags, images } = requestBody
